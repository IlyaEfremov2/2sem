...
namespace CircleTests
{
    ...
    public:
        ...
        {
            Circle circle(Point(10, 10), 5, 100);
    ...
    public:
        TEST_METHOD(CircleConstructor_ValidParams_CreatesCircle)
        {
            ...
            unsigned int maxCoord = 100;

            Circle circle(center, radius, maxCoord);

            Assert::AreEqual(10u, circle.getCenter().getX());
            Assert::AreEqual(10u, circle.getCenter().getY());
            Assert::AreEqual(5u, circle.getRadius());
        }

        TEST_METHOD(CircleConstructor_ZeroRadius_ThrowsException)
        {
            auto func = [] {
                Circle circle(Point(10, 10), 0, 100);
                };
        ...
        {
            auto func = [] {
                Circle circle(Point(95, 95), 10, 100);
                };
        ...
        {
            Circle circle(Point(0, 0), 10, 100);
        ...
        TEST_METHOD(ToString_ReturnsCorrectFormat)
        {
            ...
            Assert::IsTrue(result.find("Circle with center at (10, 10)") != std::string::npos);
            Assert::IsTrue(result.find("radius 5") != std::string::npos);
        }

        TEST_METHOD(PolymorphicCall_ThroughShapePointer)
        {
            Shape* shape = new Circle(Point(0, 0), 10, 100);
